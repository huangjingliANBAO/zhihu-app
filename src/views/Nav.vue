		...
		<div class="header">
			<div class="nav">
				<div style="display: flex;align-items: center;width: 85%;">
					<router-link to="/home" class="zh-logo">
					...
					<div class="sub-nav">
						<router-link to="/home" class="sub-nav-content">首页</router-link>
						<router-link to="/explore" class="sub-nav-content">发现</router-link>
						<router-link to="/question/waiting" class="sub-nav-content">等你来答</router-link>
					</div>
					<div class="search"><input type="text" placeholder="新型冠状病毒" />
				...
				<div class="my-nav">
					...
					<router-link to="/login" class="sub-nav-content">
						<button style=" border-style: none; background: #0084FF;width: 55px;
		height: 40px;border-radius: 5px;">登录</button></router-link>
				</div>
			</div>
		</div>
		<!--二级路由入口-->
